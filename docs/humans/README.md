...
| `feature/sim-index/core` | `crate/xtask` | 3 | Generate, query, route, prove, and check duplicate implementation overlap, including normalized public record-shape candidates, in the SIM Index graph as a checked constellation surface. |
