...
| --- | --- | ---: | --- |
| `feature/sim-tooling/generated-docs` | `crate/xtask` | 3 | Generate repo contracts, feature maps, card indexes, index fragments and claim certificates, and managed vault note namespaces through xtask; selected repo-contract artifacts can also be emitted without mutating source. |
